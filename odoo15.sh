...
# Perpose   : Automate your Odoo 15 environment setup effortlessly – from Git and Python installation to version-specific Odoo deployment.
# Supported : Ubuntu 24.04.2 LTS
...
if ! grep -q "alias v15=" "$bashrc"; then
    ...
    echo "alias 15=\"source $venv_dir/bin/activate && cd $odoo_dir/odoo_15\"" >> "$bashrc"
...
echo -e "Odoo 15 folder: $odoo_dir/odoo_15"
echo ""
...
echo ""
echo "For support, queries, or collaboration, feel free to connect:"
