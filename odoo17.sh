...
# Perpose   : Automate your Odoo 17 environment setup effortlessly – from Git and Python installation to version-specific Odoo deployment.
...
if ! grep -q "alias v17=" "$bashrc"; then
    ...
    echo "alias 17=\"source $venv_dir/bin/activate && cd $odoo_dir/odoo_17\"" >> "$bashrc"
...
echo -e "Odoo 17 folder: $odoo_dir/odoo_17"
echo ""
