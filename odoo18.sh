...
# Perpose   : Automate your Odoo 18 environment setup effortlessly – from Git and Python installation to version-specific Odoo deployment.
...
echo -e "Odoo 18 folder: $odoo_dir/odoo_18"
echo ""
